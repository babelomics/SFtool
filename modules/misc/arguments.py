...
def arguments():
    ...
    # STRipy output
    parser.add_argument("--STRipy_output", type=str, default="None", help="Path to JSON file generated by STRIpy pipeline v2.5 or above. No STRipy JSON file provided by default")
