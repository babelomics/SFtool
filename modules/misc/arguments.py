...
def arguments():
    ...
    # STRipy output
    parser.add_argument("--STRipy_output", type=str, default="None", help="Path to JSON file generated by STRIpy pipeline v2.5 or above.")

    # SMAca output
    parser.add_argument("--SMAca_output", type=str, default="None", help="Path to CSV file generated by SMAca pipeline v1.2.3 or above.")
    try:
