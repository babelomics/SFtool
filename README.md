...
For each variant, the following information is provided:
   ...
   - **Transcript**: transcript of the variant
   - **HGVSC**: HGVSC nomenclature for the variant
   - **HGVSP**: HGVSP nomenclature for the variant
   ...
   - **GeneBe_ACMG_Classification**: ACMG classification of the variant according to the GeneBe tool
   - **GeneBe_ACMG_criteria**: The list of ACMG criteria codes, each providing different levels of evidence for or against variant pathogenicity.
